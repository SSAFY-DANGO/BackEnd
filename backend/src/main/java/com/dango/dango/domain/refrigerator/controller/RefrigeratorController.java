...
public class RefrigeratorController {
    ...
    @PostMapping
    public ResponseEntity<String> registerRefrigerator(@RequestBody String nickname) {
        ...
        return new ResponseEntity<>(res.getNickname() + " 냉장고 등록 완료", HttpStatus.OK);
    }

    @PutMapping
    public ResponseEntity<String> editRefrigerator(@RequestBody String nickname) {
